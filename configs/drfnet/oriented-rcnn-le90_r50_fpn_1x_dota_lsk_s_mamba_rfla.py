...
model = dict(
    ...
    backbone=dict(
        ...
        drop_path_rate=0.1,
        depths=[2,2,4,2],
        init_cfg=dict(type='Pretrained', checkpoint="https://download.openmmlab.com/mmrotate/v1.0/lsknet/backbones/lsk_s_backbone-e9d2e551.pth"),
    ...
    train_cfg=dict(
        rpn=dict(
            assigner=dict(
                ...
                ignore_iof_thr=-1,
                gpu_assign_thr=512,
                iou_calculator=dict(type='RBbox2HBboxDistanceMetric'),
                assign_metric='kl',
                # assign_metric='iou',
                # assign_metric='giou',
                topk=[2,1],
