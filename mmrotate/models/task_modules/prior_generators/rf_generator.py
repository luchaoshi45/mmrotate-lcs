...
class RFGenerator:
    """receptive field generator for 2D anchor-based detectors.
    """

    def __init__(self,
                 strides,
                 ratios=[0.5, 1.0, 2.0],
                 fraction=0.5,  # estimate the effective receptive field
                 fpn_layer='p3',  # the start level of FPN, for two-stage detectors it should be switched to P2
                 scales=[1.0],
                 base_sizes=None,
                 scale_major=True,
