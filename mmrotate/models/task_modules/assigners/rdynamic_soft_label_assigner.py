...
class RDynamicSoftLabelAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        priors = pred_instances.priors.tensor
        decoded_bboxes = priors
        ...
        pairwise_ious = self.iou_calculator(gt_bboxes, valid_decoded_bbox)
        ...
        iou_cost = iou_cost.transpose(0, 1)
        cost_matrix = iou_cost + soft_center_prior
